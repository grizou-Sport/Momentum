...
(function initializeMomentumWellbeing() {
  const ACTIVITIES = [
    ...
    { id: "nap", label: "Sieste", icon: "moon", fields: ["date", "duration", "notes"], aliases: ["sieste", "nap"], active: true, order: 20 },
    ...
    { id: "stretching", label: "Étirements", icon: "stretching", fields: ["date", "duration", "notes"], aliases: ["étirements", "etirements", "stretching"], active: true, order: 90 },
    { id: "recovery", label: "Récupération", icon: "recovery", fields: ["date", "duration", "location", "notes"], aliases: ["récupération", "recuperation", "recovery"], active: true, order: 100 },
    { id: "other", label: "Autre", icon: "circle-ellipsis", fields: ["date", "duration", "location", "notes"], aliases: ["autre", "other"], active: true, order: 999 }
  ];
