...
(function () {
  ...
  function init() {
    ...
    if (!location.hash && !location.search && window.MomentumPreferences?.get(`arrival_${page}`, 'immersive') === 'direct') target?.scrollIntoView();
  }
  Promise.resolve(window.momentumPageReady).then(init);
})();
